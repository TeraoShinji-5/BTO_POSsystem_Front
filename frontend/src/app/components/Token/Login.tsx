...
export default function Login() {
    ...
    const handleSend = async (event) => {
        ...
        const response = await fetch('tech0-gen-5-step4-studentwebapp-7.azurewebsites.net/login', {
            method: 'POST',
            body: body_msg,
            headers: {
    ...
    useEffect(() => {
        ...
        if (userName) {
            ...
            window.location.href = `tech0-gen-5-step4-studentwebapp-8.azurewebsites.net/shopping?token=${token}`;
        }
